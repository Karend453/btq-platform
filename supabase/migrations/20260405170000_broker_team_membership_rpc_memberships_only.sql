-- Align broker team RPCs with office_memberships-only writes (no user_profiles updates; multi-office allowed).
-- Safe to apply after 20260405160000 if that migration already ran with the previous function bodies.
