-- Back Office: insert a row into public.offices (existing columns only).
-- Same temporary `admin` BTQ wall as list_offices_for_back_office; not the final role model.
