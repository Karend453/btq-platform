...
export const RESOURCE_CENTER_SECTIONS: ResourceSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: "Set up your account and office",
        description:
          "Quick walkthrough of forms provider setup, adding agents/admins, and basic office configuration.",
        url: "https://youtu.be/79fuo7ZcnPs",
        provider: "btq",
  ...
  },
  {
    id: "lofty",
    title: "Lofty",
    description: "CRM, lead management, marketing automation, and website tools.",
    provider: "lofty",
    sortOrder: 20,
    items: [
      {
        id: "lofty-crm-getting-started",
        title: "Lofty CRM Getting Started",
        description:
          "New to Lofty? Start here for a walkthrough of the core CRM features and daily workflow basics.",
        url: "https://www.loom.com/share/67b47589778843dc93ca44498047fdc2",
        provider: "lofty",
        audience: ["Agent", "Admin", "Broker"],
        duration: "12 min",
      ...
      {
        id: "lofty-dashboard-overview",
        title: "Lofty Dashboard Overview",
        description:
          "Learn how to navigate the Lofty dashboard, track activity, and quickly access your most important tools.",
        url: "https://www.loom.com/share/f4a9ec918d0f41929f54329246dd7912",
        provider: "lofty",
        audience: ["Agent", "Admin", "Broker"],
        duration: "11 min",
        category: "Getting Started",
      ...
      {
        id: "lofty-lead-management",
        title: "Lead Management",
        description:
          "Learn how to organize, prioritize, and manage leads efficiently inside Lofty.",
        url: "https://www.loom.com/share/00f2bdae4304472e8a1147fa6d505b20",
        provider: "lofty",
        audience: ["Broker", "Admin"],
        duration: "7 min",
        category: "Lead Management & Conversion",
        sortOrder: 30,
      },
      {
        id: "lofty-lead-profile-page",
        title: "Lead Profile Page",
        description:
          "Understand the Lead Profile page and how to track communication, activity, and engagement.",
        url: "https://www.loom.com/share/77bea0270f684bd9a8e87fcbaa7e0aac?t=334",
        provider: "lofty",
        audience: ["Agent", "Admin", "Broker"],
        duration: "9 min",
        category: "Lead Management & Conversion",
      ...
      {
        id: "lofty-optimizing-lead-routing",
        title: "Optimizing Lead Routing",
        description:
          "Make sure the right leads get assigned to the right agents with smarter lead routing strategies.",
        url: "https://www.loom.com/share/274047282df0443e951ea9ac9a6fbf9b?t=355",
        provider: "lofty",
        audience: ["Broker", "Admin"],
        duration: "21 min",
        category: "Lead Management & Conversion",
      ...
      {
        id: "lofty-social-studio-ai-marketer",
        title: "Social Studio's AI Marketer",
        description:
          "Use AI-powered marketing tools inside Lofty to create content and stay active on social media.",
        url: "https://www.loom.com/share/e6e7713204da4ff38d28a5a7bde5bb9c?t=0",
        provider: "lofty",
        audience: ["Agent", "Admin", "Broker"],
        duration: "7 min",
      ...
      {
        id: "lofty-smart-plan-builder",
        title: "Smart Plan Builder",
        description:
          "Build automated workflows and follow-up plans to keep leads engaged automatically.",
        url: "https://www.loom.com/share/a22d8ca5798048b6bc2f8cd541f0ae11?t=0",
        provider: "lofty",
        audience: ["Broker", "Admin"],
        duration: "15 min",
        category: "Marketing & Automation",
      ...
      {
        id: "lofty-better-landing-pages",
        title: "A Better Way to Do Lofty Landing Pages",
        description:
          "Improve your Lofty landing pages with cleaner layouts and better lead conversion strategies.",
        url: "https://youtu.be/0taz1QxTr20?si=yM3L7_vlK_7lS6a8",
        provider: "lofty",
        audience: ["Agent", "Admin", "Broker"],
        duration: "8 min",
      ...
      {
        id: "lofty-website-editing",
        title: "Website Editing",
        description:
          "Learn how to customize and manage your Lofty website design, pages, and branding.",
        url: "https://www.loom.com/share/e178b064f9a945169023353ac4ca2451",
        provider: "lofty",
        audience: ["Broker", "Admin"],
        duration: "34 min",
        category: "Websites & Landing Pages",
